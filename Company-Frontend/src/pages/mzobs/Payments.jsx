  ...
  return (
    <StaggerGroup>
      <StaggerItem className="mb-6">
        ...
        <p className="text-sm text-ink-secondary mt-1">Two revenue lines: ₹99 one-time from each candidate, and ₹2,000 per opening from each employer.</p>
      </StaggerItem>
      ...
      <StaggerItem className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-5">
        ...
        <Card hover pad>
          ...
          <div className="text-[17px] font-bold tracking-tight mt-2.5">₹99 / candidate</div>
