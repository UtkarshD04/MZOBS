...
export default function CommandPalette() {
  ...
  const commands = useMemo(() => {
    return [
      ...
      { grp: 'Navigate', icon: Building2, label: 'Go to Companies', act: () => navigate('/app/companies') },
      { grp: 'Navigate', icon: Briefcase, label: 'Go to Requirements', act: () => navigate('/app/requirements') },
      { grp: 'Navigate', icon: ClipboardList, label: 'Go to Applications', act: () => navigate('/app/applications') },
      { grp: 'Navigate', icon: Send, label: 'Go to Resume Dispatch', act: () => navigate('/app/dispatch') },
