  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none z-0 overflow-hidden">
        ...
        >
          <defs>
            <linearGradient id="mzobsRibbonGradFrontend" x1="0%" y1="0%" x2="100%" y2="100%">
            ...
            <linearGradient id="mzobsRibbonGradSubtleFrontend" x1="0%" y1="0%" x2="100%" y2="100%">
          ...
          <path
            ...
            fill="none"
            stroke="url(#mzobsRibbonGradFrontend)"
            strokeWidth="3.5"
            strokeLinecap="round"
          />
          ...
          <path
            ...
            fill="none"
            stroke="url(#mzobsRibbonGradSubtleFrontend)"
            strokeWidth="1.5"
