        ...
        >
          ...
          <Reveal direction="up" delay={0.15} duration={0.9} scale={0.94} blur className="relative z-10 h-full flex flex-col justify-end p-8 sm:p-14 max-w-2xl space-y-5">
            ...
            <div className="pt-2 flex flex-wrap items-center gap-3">
              ...
              <Link
                to="/employers/signin"
                className="inline-flex items-center px-7 py-3.5 rounded-full border border-[#e0e0e0] bg-white text-[#111827] text-sm font-bold hover:border-[var(--careers-accent)] transition-colors"
              >
                Sign in
              </Link>
            </div>
