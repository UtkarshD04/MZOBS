...
// The benefits below are the ones the Mzobs Ally brief lists. Each is shown
...
const JOURNEY = ['Apply', 'Get selected', 'Get your Ally ID', 'Build your campus community', 'Connect students', 'Create impact']
    ...
    >
      <div className="cm-pass-inner">
        <div className="cm-face">
          ...
          <div className="role">Mzobs<br /><b>Ally</b></div>
          <div className="row">
            <div className="ident">
    ...
    <div className="cm-form-wrap" ref={top}>
      ...
      <form className="cm-panel" onSubmit={(e) => { e.preventDefault(); if (step === 4) submit(); else next() }} noValidate>
        <div className="cm-step-pane" key={step}>
          ...
          {step === 3 && (
            <>
              <h3>Why Mzobs</h3><p className="s">What draws you to being a Mzobs Ally?</p>
              <div className="cm-fgrid">
    ...
    <div className="cm" style={{ '--cm-jaali-dark': jaali('rgba(120,220,205,0.45)') }}>
      ...
      <section className="cm-sec" id="why">
        <div className="cm-wrap cm-more">
          <div>
            <Rv as="p" className="cm-eyebrow">What is a Mzobs Ally?</Rv>
            <IntroHeading />
            <Rv as="p" d={0.15} className="cm-statement">A Mzobs Ally is a student representative who helps connect their community with meaningful career opportunities, hiring initiatives, events and the Mzobs ecosystem.</Rv>
          </div>
          <div>
      ...
      <section className="cm-sec" style={{ paddingTop: 0 }}>
        <div className="cm-wrap">
          ...
          <div className="cm-flow" ref={flowRef} aria-label="Student to Mzobs Ally to Mzobs to opportunity to student community">
            {[['Student', 'Starts here'], ['Mzobs Ally', 'You', true], ['Mzobs', 'The platform'], ['Opportunity', 'Jobs & careers'], ['Student community', 'Everyone benefits']].map(([v, k, hero], i, arr) => (
      ...
      <section className="cm-sec" id="how" style={{ background: '#fff', borderBlock: '1px solid var(--cm-line)' }}>
        <div className="cm-wrap">
          ...
          <Rv as="h2" d={0.06} className="cm-h2">The Ally journey.</Rv>
      ...
      <section className="cm-sec" id="benefits">
        <div className="cm-wrap">
          ...
          <Rv as="h2" d={0.06} className="cm-h2">As a Mzobs Ally,<br />you get access to.</Rv>
      ...
      <section className="cm-sec cm-dark cm-cta" id="apply" style={{ paddingBottom: 'clamp(70px, 9vw, 120px)' }}>
        <div className="cm-wrap">
          ...
          <Rv as="h2" d={0.06} className="cm-h2">Ready to become a Mzobs Ally?</Rv>
          ...
          <Rv d={0.22} style={{ marginTop: 34 }}>
            <a href="#apply-form" onClick={go('apply-form')} className="cm-btn cm-btn-light">Become a Mzobs Ally <ArrowRight size={16} /></a>
          </Rv>
        </div>
      </section>
      ...
      <section className="cm-sec cm-dark cm-final" style={{ paddingBottom: 60 }}>
        <div className="cm-wrap">
          ...
          <Rv d={0.12}><a href="#apply-form" onClick={go('apply-form')} className="cm-btn cm-btn-light">Become a Mzobs Ally <ArrowRight size={16} /></a></Rv>
          <div className="cm-foot">
            <Link to="/" className="cm-logo" aria-label="Mzobs home"><img src="/images/logo.png" alt="Mzobs" draggable="false" /></Link>
            <span>Mzobs Ally · 2026</span>
          </div>
        </div>
      </section>
    </div>
...
function IntroHeading() {
  ...
  return (
    <h2 className="cm-h2" ref={ref}>
      ...
      <span className="cm-line"><span>ambassador. An <span className="cm-accent" style={{ display: 'inline' }}>Ally.</span></span></span>
    </h2>
  )
}
