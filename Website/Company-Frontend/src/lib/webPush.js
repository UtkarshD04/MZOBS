...
// under this app's /api/staff/... base — it's unauthenticated on purpose so
// Landing-Frontend (no login) can fetch it too. Derive the root from
...
// to the signed-in staff member's account. No-ops quietly if the browser
// doesn't support push, or the user denies/dismisses the prompt.
