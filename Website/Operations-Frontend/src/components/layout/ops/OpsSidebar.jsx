  ...
  return (
    ...
    >
      {({ isActive }) => (
        <>
          {isActive && (
            <motion.div layoutId="ops-nav-pill" className="absolute left-0 top-0 bottom-0 w-[3px] rounded-r-[3px] bg-gradient-to-b from-navy to-gold-dot" transition={{ type: 'spring', stiffness: 500, damping: 40 }} />
          )}
