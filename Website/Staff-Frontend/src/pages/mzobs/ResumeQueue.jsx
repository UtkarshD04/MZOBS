  ...
  return (
    <StaggerGroup>
      <StaggerItem className="mb-6">
        ...
        <p className="text-sm text-ink-secondary mt-1">Resumes an admin has referred to you for review.</p>
      </StaggerItem>
      ...
      <StaggerItem>
        {rows.length === 0 ? (
          <Card>
            <EmptyState icon={FileCheck} tone="green" title="Nothing in this queue" body="Check another tab, or wait for an admin to refer you more resumes." />
          </Card>
        ) : (
