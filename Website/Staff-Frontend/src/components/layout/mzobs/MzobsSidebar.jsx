...
import { FileCheck, Video, Inbox, LifeBuoy, LogOut, PanelLeft } from 'lucide-react'
...
export default function MzobsSidebar() {
  ...
  const items = [
    { to: '/app/resumes', label: 'Resume Verification', icon: FileCheck },
    { to: '/app/resume-pool', label: 'My Resume Pool', icon: Inbox },
