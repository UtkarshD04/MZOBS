  ...
  return (
    <section className="bg-[#EEF3F8] py-20 px-6 md:px-12 border-t border-slate-200/50">
      <div className="max-w-7xl mx-auto grid lg:grid-cols-12 gap-8 items-stretch">
        ...
        <Reveal direction="left" className="lg:col-span-6 bg-white rounded-3xl p-8 sm:p-12 border border-slate-200/60 shadow-sm flex flex-col justify-between space-y-8">
        ...
        {/* Right Photo Card */}
        <Reveal direction="right" delay={0.1} className="lg:col-span-6 min-h-[380px] sm:min-h-[440px] rounded-3xl overflow-hidden shadow-md border border-slate-200/60 group">
          <img
            src={goalData.image}
