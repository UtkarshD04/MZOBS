            ...
            <div key={s.n} className="relative">
              <Card pad className="h-full">
                <div className="flex items-center justify-between mb-3">
                  <div className="w-9 h-9 rounded-lg bg-navy-tint text-navy flex items-center justify-center">
                    <s.icon size={16} />
                  </div>
              ...
              {i < steps.length - 1 && <ArrowRight size={16} className="hidden lg:block absolute top-1/2 -right-[22px] -translate-y-1/2 text-ink-tertiary" />}
            </div>
          ))}
        </div>
      </div>
