...
import { forgotPasswordEmployee } from '../../lib/employeeAuth'
...
export default function EmployeeForgotPasswordForm() {
  ...
  if (status === 'success') {
    return (
      <div className="flex flex-col items-center justify-center text-center py-6">
        ...
        <Link to="/employees/signin" className="text-xs font-bold text-[#595959] hover:text-black transition-colors mt-6">
          Back to sign in
        </Link>
      </div>
    )
