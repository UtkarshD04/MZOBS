...
export default function Interviews() {
  ...
  const [feedbackOutcome, setFeedbackOutcome] = useState<'Selected' | 'Not selected' | 'On hold'>('Selected')

  const [form, setForm] = useState({ candidateId: '', round: '', date: '', time: '', durationMins: 45, mode: 'Video Call' as InterviewMode, location: '', meetingLink: '' })
  ...
  return (
    <div>
      ...
      >
        ...
        <Field label="Outcome">
          <Select value={feedbackOutcome} onChange={(e) => setFeedbackOutcome(e.target.value as typeof feedbackOutcome)}>
