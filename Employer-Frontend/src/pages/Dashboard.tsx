...
interface StatCardDef {
  ...
  delta: string
  icon: LucideIcon
  tone: 'navy' | 'gold' | 'green' | 'violet' | 'teal' | 'amber'
}
...
function toneStyle(tone: StatCardDef['tone']) {
  const map: Record<StatCardDef['tone'], { bg: string; fg: string }> = {
...
function QuickAction({ icon: Icon, label, sub, onClick }: { icon: LucideIcon; label: string; sub: string; onClick: () => void }) {
  return (
