...
import { jobDefaultValues, jobSchema, type JobFormValues } from '../schemas/jobSchema'
...
export default function JobForm() {
  ...
  const {
    ...
    reset,
    formState: { errors },
  } = useForm<JobFormValues>({ resolver: zodResolver(jobSchema), defaultValues: jobDefaultValues })
  ...
  function submitAs(status: JobStatus) {
