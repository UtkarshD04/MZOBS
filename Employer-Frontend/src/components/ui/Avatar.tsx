...
export default function Avatar({ initials, size = 'default', gold, className }: AvatarProps) {
  return (
...
export function CompanyLogo({ initials, size = 'md', tone = 'navy', className }: { initials: string; size?: keyof typeof logoSizes; tone?: keyof typeof logoTones; className?: string }) {
